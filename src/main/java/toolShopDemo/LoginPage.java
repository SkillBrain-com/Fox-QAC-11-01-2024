...
public class LoginPage {
    ...
    private By userName = By.cssSelector(".mb-3>input[placeholder=\"Enter your E-mail\"]");
    private By password = By.xpath("//div[@class=\"mb-3\"]/child::input[@placeholder=\"Enter your Password\"]");
