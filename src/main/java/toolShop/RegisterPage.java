...
public class RegisterPage {
    ...
    public void register(String firstName, String lastName, String dateOfBirth, String address, String postcode, String city, String state, String country, String phone, String email, String password){
...
// Instantiem clasa Select careia ii dam ca si parametru dropDownul nostru
        // apoi folosim obiectul de tip creat
        // putem sa selectam dupa diverse criterii(text vizibil, index, etc)
