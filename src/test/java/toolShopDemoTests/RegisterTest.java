...
public class RegisterTest extends BasePage {
    ...
    public void registerTest(){
        ...
        registerPage.register(data.firstName, data.lastName, data.dateOfBirth, data.address, data.postCode, data.city,
                data.state, data.country, data.phone, data.email, data.password);
